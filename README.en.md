...
**English | [中文](README.md) | [台灣正體](README.zhtw.md) | [Tiếng Việt](README.vi.md) | [தமிழ்](README.ta.md)**
...
The Chinese original lives in [`book/`](book/). The Traditional Chinese (Taiwan), English, Tamil, and Vietnamese translations are **community-contributed** and live in [`book-zhtw/`](book-zhtw/), [`book-en/`](book-en/), [`book-ta/`](book-ta/), and [`book-vi/`](book-vi/) respectively; they may lag behind the Chinese original:
...
5. **New Translation Versions**: Translating the book into more languages — see how the Traditional Chinese/Taiwan (`book-zhtw/`), English (`book-en/`), Tamil (`book-ta/`), and Vietnamese (`book-vi/`) versions are organized
