...
| 📚 **10 chapters** of text, from basics to production | 📂 **88** companion projects (70+ standalone) | 🌐 **4 languages**: CN / EN / TA / VI |
| :---: | :---: | :---: |
...
Chinese text source is in [`book/`](book/); English/Tamil/Vietnamese translations are community contributions (may lag behind the Chinese original), located in [`book-en/`](book-en/), [`book-ta/`](book-ta/), [`book-vi/`](book-vi/) respectively.
...
| 🌐 **New translations** | Translations into more languages are welcome; see English (`book-en/`), Tamil (`book-ta/`), Vietnamese (`book-vi/`) for reference |
